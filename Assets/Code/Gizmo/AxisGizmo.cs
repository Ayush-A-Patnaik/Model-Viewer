...
public class AxisGizmo : MonoBehaviour
{
    ...
    private float _clickRadius = 30f;
    ...
    public void SnapToAxis(AxisDirection axis)
    {
        ...
        switch (axis)
        {
            case AxisDirection.PositiveX: direction = Vector3.left; break;
            case AxisDirection.NegativeX: direction = Vector3.right; break;
            case AxisDirection.PositiveY: direction = Vector3.down; break;
            case AxisDirection.NegativeY: direction = Vector3.up; break;
